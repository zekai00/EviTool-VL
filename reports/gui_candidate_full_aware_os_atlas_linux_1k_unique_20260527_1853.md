...
- Input dir: `outputs/gui_candidate_rl_os_atlas_linux_1k_unique_c60_menu_table_refined_20260527_1853`
- Output dir: `outputs/gui_candidate_rl_os_atlas_linux_1k_unique_c60_menu_table_refined_full_aware_20260527_1853`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| all | 1000 | 693 | 41.2400 | 14.6040 | 69.70% | 58.20% | 0.4971 | 0.2320 | 0.00% |
| train | 547 | 547 | 42.7441 | 15.1115 | 100.00% | 83.73% | 0.7019 | 0.2318 | 0.00% |
| val | 200 | 146 | 38.1250 | 14.5400 | 73.50% | 61.50% | 0.5241 | 0.2326 | 0.00% |
| val_oracle_hit | 146 | 146 | 38.2808 | 15.0822 | 100.00% | 84.25% | 0.7117 | 0.2326 | 0.00% |

## Full-Aware Action 角色分布（Train）

| Role | Count |
|---|---:|
| `current_model_proxy_false_positive` | 2170 |
| `detector_top_rank_wrong` | 2170 |
| `distant_false_positive` | 960 |
| `high_iou_wrong` | 1631 |
| `high_reward_wrong` | 1631 |
| `near_center_wrong` | 1631 |
| `oracle_positive` | 547 |
| `random_full_pool_negative` | 4323 |
| `text_similar_wrong` | 1454 |
